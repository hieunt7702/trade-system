              ...
              <div className="absolute left-0 top-full mt-2 w-full z-50">
                <div className="rounded-xl border border-white/10 bg-zinc-900/95 backdrop-blur-md p-1.5 shadow-2xl flex flex-col gap-1">
                  <button
                    ...
                    className={`w-full text-left rounded-lg px-3 py-2 text-sm transition ${statusFilter === '' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-300 hover:bg-white/5 hover:text-white'}`}
                  >
                    Tất cả trạng thái
                  </button>
                  <button
                    ...
                    className={`w-full text-left rounded-lg px-3 py-2 text-sm transition ${statusFilter === 'ACTIVE' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-300 hover:bg-white/5 hover:text-white'}`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full text-left rounded-lg px-3 py-2 text-sm transition ${statusFilter === 'INACTIVE' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-300 hover:bg-white/5 hover:text-white'}`}
                  >
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-xl text-sm text-white focus:outline-none focus:border-blue-500/50"
              ...
              <div>
                <label className="block text-xs font-bold text-zinc-400 mb-1 uppercase tracking-wide">Trạng thái hoạt động</label>
                  <details className="relative group w-full" data-hh-nav-dropdown="">
                    <summary className="list-none cursor-pointer w-full px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-xl text-sm text-white flex items-center justify-between focus:outline-none focus:border-cyan-500/50">
                    ...
                    <div className="absolute left-0 top-full mt-2 w-full z-50">
                      <div className="rounded-xl border border-white/10 bg-zinc-900/95 backdrop-blur-md p-1.5 shadow-2xl flex flex-col gap-1">
                        <button
                          ...
                          className={`w-full text-left rounded-lg px-3 py-2 text-sm transition ${formData.status === 'ACTIVE' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-300 hover:bg-white/5 hover:text-white'}`}
                        >
                          Hoạt động (ACTIVE)
                        </button>
                        <button
                          ...
                          className={`w-full text-left rounded-lg px-3 py-2 text-sm transition ${formData.status === 'INACTIVE' ? 'bg-orange-500/10 text-orange-400' : 'text-zinc-300 hover:bg-white/5 hover:text-white'}`}
                        >
                          Ngừng hoạt động (INACTIVE)
                        </button>
                      </div>
